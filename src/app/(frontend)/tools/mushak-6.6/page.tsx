...
// --- Main Component ---
export default function Mushak66Page() {
    ...
    <div className="min-h-screen bg-neutral-50 p-4 md:p-8 pt-24 md:pt-32">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 tracking-tight flex items-center gap-2">
              ...
              Mushak 6.6 Generator
            </h1>
            <p className="text-gray-500 mt-2">
              Generate Certificate of Tax Deduction at Source (VDS) seamlessly.
            </p>
          </div>
          <button
            onClick={() => handlePrint()}
            className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-xl shadow-md shadow-blue-200 transition-all font-medium active:scale-95"
          >
        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-8 items-start">
          ...
          <div className="xl:col-span-7 bg-gray-200/50 rounded-2xl p-4 md:p-8 overflow-x-auto flex justify-center border border-gray-200 shadow-inner">
            <div 
              ref={contentRef}
              className="bg-white shadow-2xl print:shadow-none w-[297mm] min-h-[210mm] p-[20mm] text-black print:w-full print:p-[15mm] shrink-0 print:overflow-hidden"
            ...
            >
                  ...
                  <tbody>
                    {invoices.map((inv, idx) => (
                      <tr key={inv.id} className="break-inside-avoid">
                        ...
                        <td className="border-2 border-black p-1.5 text-center">{inv.issueDate ? new Date(inv.issueDate).toLocaleDateString('en-GB').replace(/\//g, '.') : ''}</td>
              ...
              {/* Signatures */}
              <div className="text-[14px] font-bold break-inside-avoid mt-20">
